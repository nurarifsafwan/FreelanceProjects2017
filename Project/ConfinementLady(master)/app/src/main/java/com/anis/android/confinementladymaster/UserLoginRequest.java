...
public class UserLoginRequest extends StringRequest{
    ...
    private static final String LOGIN_USER_REQUEST_URL = "http://10.0.2.2/confinement/loginuser.php";
    private Map<String, String> params;

    public UserLoginRequest(String username, String password, Response.Listener<String> listener){
        super(Request.Method.POST, LOGIN_USER_REQUEST_URL, listener, null);
        params = new HashMap<>();
